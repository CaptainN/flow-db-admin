...
Meteor.methods({
  ...
  //   }
  // },
  adminAddUserToGroup (_id, role, group) {
    check(_id, String)
    check(role, String)
    check(group, String)
    if (isGroupAdmin(this.userId, 'super')) {
      return Roles.addUsersToRoles(_id, role, group)
    }
  },
  adminRemoveUserFromGroup (_id, role, group) {
    check(_id, String)
    check(role, String)
    check(group, String)
    if (isGroupAdmin(this.userId, 'super')) {
      return Roles.removeUsersFromRoles(_id, role, group)
    }
  },
