...
Template.AdminDashboardUsersEdit.events({
  ...
  // },
  'click .btn-add-group' (e, t) {
    Meteor.call('adminAddUserToGroup', $(e.target).attr('user'), 'admin', $(e.target).attr('group'))
  },
  'click .btn-remove-group' (e, t) {
    Meteor.call('adminRemoveUserFromGroup', $(e.target).attr('user'), 'admin', $(e.target).attr('group'))
  }
})
